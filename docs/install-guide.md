...
All 17 community plugins are pre-installed in `.obsidian/plugins/`. Enable them in **Settings → Community Plugins → toggle on**.

See `wiki/START-HERE.md` for the full plugin list with feature descriptions.

**Minimum required:** Bases (core), Templater, Obsidian Git.
